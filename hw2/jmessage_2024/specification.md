...
```
<!-- curl -k https://127.0.0.1:8080/login/alice/abc -->
<!-- curl -k https://127.0.0.1:8080/login/yanz/123456 -->
...
/listUsers
```
<!-- curl -k https://127.0.0.1:8080/listUsers -->
...
```
<!-- curl -k -X POST -H "Content-Type: application/json" -d '{"encPK": "", "sigPK": ""}' http://127.0.0.1/uploadKey/alice/apikey -->
...
```
<!-- curl -k https://127.0.0.1:8080/lookupKey/alice -->
...
```
<!-- curl -k -X POST -H "Content-Type: application/json" -d '{"from": "alice", "to": "yanz", "id": "1", "receiptID": "0", "payload": "null"}' https://127.0.0.1:8080/sendMessage/alice/MPNrxOWcU1yXArOam9vdaIYc -->
...
```
<!-- curl -k https://127.0.0.1:8080/getMessages/yanz/AFCfQZHIx22tjzFfNFyIOAC6 -->
